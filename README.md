...
Currently tracks 6 AI companies (Anthropic, Claude, OpenAI, DeepMind, DeepSeek, xAI) and 2 photonics journals (Nature Photonics, Light: Science & Applications). 23 sources, all fetched concurrently in 2 seconds.
...
```
subscope fetch               # pull all sources (23 sources, ~2s)
...
Site-specific adapters: Anthropic (RSC JSON payload), Claude blog (HTML articles), Claude support (Intercom), DeepSeek (changelog HTML), xAI (news page).
