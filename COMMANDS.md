...
subscope eco                      economics & finance (17 econ/* sources)
subscope glob                     global news (18 news/* sources)
...
- `eco` -- group prefix `econ` (17 sources: Fed, ECB, PBOC, BOJ, BOE, NBS, BLS, BEA, SEC, Treasury, IMF, CSRC, MOF, SAFE, NFRA, CFPB, CFTC)
...
Other groups (use `-g` flag): `energy` (IEA, EIA, DOE, OPEC, IRENA), `intl` (UN, WHO, IAEA, WTO, World Bank, NATO, OECD), `reg` (EU Commission, FTC, FCC).
